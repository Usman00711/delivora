...
Add full agency-side forms and server actions for:
...
- Toasts.
- Better form loading states.
- More complete empty states.
- Error boundaries.
- Project creation wizard.
- Better detail pages for action center items.
...
- Production-safe seed/demo strategy.
- Deployment notes.
- Portfolio README screenshots.

## Current Limitations

- Most agency CRUD is not implemented yet.
- File uploads are represented as URLs for now.
- Invoices are simulated and do not connect to a payment processor.
- Email invitations are not implemented yet.
- Recharts is installed but charts are not yet used in the UI.
- The app is ready for local MVP testing, not final production deployment.
